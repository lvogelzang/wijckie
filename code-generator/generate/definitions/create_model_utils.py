...
from generate.definitions.fields.foreignKey import ForeignKey, OnDelete
...
from generate.definitions.model_field_types import (
...
def _create_module(module_name):
    name, plural_name = _model_names(module_name, "module")
...
def _create_widgets(module_name, module_model):
    name, plural_name = _model_names(module_name, "widget")
    return [
        _create_model(
            module_name,
            name,
...
def _create_extra_classes(module_name, module, widgets):
    ...
    while True:
        ...
        extra_classes.append(
            _create_model(
                module_name, name, plural_name, [], module=module, widgets=widgets
            )
        )
